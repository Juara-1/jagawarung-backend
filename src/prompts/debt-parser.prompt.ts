 ...
 * - action: The intended operation (repay_debt, get_debt, or upsert_debt)
 * - debtor_name: The name of the person involved in the debt
 * - nominal: The monetary amount mentioned
 * 
 * TODO: Replace this placeholder with your actual system prompt
 */
...
- action: One of "upsert_debt", "repay_debt", or "get_debt" (string)
...
export const DEBT_PARSER_RESPONSE_SCHEMA = {
  ...
  properties: {
    ...
    action: {
      type: 'string',
      enum: ['repay_debt', 'get_debt', 'upsert_debt'],
